...
import org.wrml.core.runtime.bootstrap.BootstrapSchema;
import org.wrml.core.runtime.bootstrap.FieldBootstrapSchema;
import org.wrml.core.runtime.bootstrap.FieldNames;
import org.wrml.core.runtime.bootstrap.SchemaBootstrapSchema;
...
public final class SystemSchemaService extends ProxyService
{
    ...
    public static final String MODEL_SCHEMA_FULL_NAME = "org.wrml.core.Model";
    ...
    public Object get(URI schemaId, Object cachedEntity, MediaType responseType, Model referrer) {
        ...
        if (_SchemaBootstrapSchema.getId().equals(schemaId)) {
            ...
            /*
             * A Request to get "org.wrml.core.model.schema.Schema", return the
             ...
             * implementation.
             * 
             * A Request to get "org.wrml.core.model.schema.Field", return the
